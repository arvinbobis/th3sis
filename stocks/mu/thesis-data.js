...
const TEXT = {
  ...
  current: {
    ...
    fy26CardHtml: (fyRev, growthPct) => `Q3 FY2026's actual plus base-case Q4 FY26–Q2 FY27 projections sum to roughly <span style="color:var(--blue-soft);font-weight:700">$${fyRev}B</span> across the next four quarters — the growth path today's price already assumes. FY2025 full-year actual revenue was <span style="color:#66b278">$37.4B</span>, so this implies <em>~${growthPct}%</em> growth versus that base — a measure of how much the supercycle has already changed the scale of the business, not a like-for-like annual comparison.`,
