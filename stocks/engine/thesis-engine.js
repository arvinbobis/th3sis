...
function PastTab() {
  ...
  const capexStatus = latestCapex < 35 && latestFCF > PAST_FCF[nY - 2] ? { label: "DISCIPLINED", desc: latestCapex < peakCapex ? `${latestCapex}% CAPEX/REVENUE \xB7 DOWN FROM ${peakCapex}% PEAK` : `${latestCapex}% CAPEX/REVENUE \xB7 AT WINDOW HIGH, FCF STILL GROWING`, col: "#66b278" } : latestCapex < 45 ? { label: "ELEVATED", desc: `${latestCapex}% CAPEX/REVENUE \xB7 WATCH FCF`, col: "#c59542" } : { label: "AGGRESSIVE", desc: `${latestCapex}% CAPEX/REVENUE \xB7 HIGH SPEND`, col: "#dd817a" };
