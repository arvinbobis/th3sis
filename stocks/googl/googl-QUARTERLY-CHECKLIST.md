...
WHAT SURPRISED ME THIS QUARTER:
  Cloud individually beat EVERY bull-case threshold this thesis had set (growth, margin, backlog) — yet the stock dropped ~7-8% anyway, purely on the capex-guidance raise ($180-190B→$195-205B). The fundamentals said bull-leaning-base; the market's reaction said bear-multiple. That gap between the print and the price reaction is the real story of this quarter, not any single number. Bigger surprise found on a closer read after the initial pass: Alphabet posted its first-ever NEGATIVE quarterly free cash flow (-$5.9B) as capex nearly doubled YoY to $44.9B — a real, not cosmetic, data point (TTM FCF still ~$53B positive, ~$240B cash/securities on hand, so no liquidity concern, but the trend matters for anyone tracking whether the spend converts).
────────────────────────────────────────────
```

*Key numbers captured: Cloud +82% YoY ($24.8B, 35.5% op margin, $514B backlog, +$50B+ QoQ) — crushed the Q1 63% print and every bull threshold. Total revenue $119.8B vs ~$108B estimate (clear beat). Search +17% YoY to $63.3B (deceleration from Q1's +19%, lands in BASE band not BULL). Capex $44.9B in Q2 (up from $35.7B), FY2026 guide raised to $195-205B from $180-190B. Free cash flow: -$5.9B in Q2 (first-ever negative quarter), TTM still +~$53B — the proximate cause of the stock's -7-8% reaction was capex/FCF optics, not the revenue/Cloud/Search prints. DOJ US case: still on appeal to the D.C. Circuit, unresolved, oral arguments expected late 2026/early 2027 — no change. EU Android case: Google's final appeal REJECTED 2026-07-02, EUR4.1B fine now final — a real, concluded, but financially modest adverse outcome, separate from the bigger pending US risk. Peer read: MSFT (~19.5-20x FY27), META (~18x FY27), AMZN (~24.5-26x FY27) forward multiples — a live, sector-wide capex-fear de-rate (median ~20.7x) that argues for a lower peer-anchored multiple than GOOGL's own recent history alone would suggest, not something specific to Alphabet.*
