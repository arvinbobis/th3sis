...
const PF_STRAT = {
  ...
  REVIEW_GATES: [
    ...
    { t:"MSFT",  date:"2026-07-29", note:"HELD. Reports Q4 FY2026 after close 2026-07-29 (confirmed via Microsoft's own investor-relations release). Kill-switch per the existing thesis: Azure decelerates below 35% in any quarter — that single data point would signal the AI tailwind fading faster than the capex assumed. Not yet audited against this print." },
    { t:"META",  date:"2026-07-29", note:"HELD. Reports Q2 2026 after close 2026-07-29 — same day as MSFT (confirmed via Meta's own investor-relations page). Kill-switch per the existing thesis: either demand quality degrades into a true bear lane, or AI monetization breaks out and forces a re-rating higher. Not yet audited against this print." },
    { t:"FICO",  date:"2026-07-29", note:"HELD. Reports Q3 FY2026 after close 2026-07-29 (confirmed via Fair Isaac's own release) — a third stock reporting the same day as MSFT/META. Kill-switch per the existing thesis: Scores growth decelerates below 15% YoY for two consecutive quarters (bear), or lender VantageScore adoption proves near-zero and Scores growth resumes 50%+ with the multiple re-expanding above 40x (bull). Not yet audited against this print." },
    { t:"AMZN",  date:"2026-07-30", note:"HELD. Reports Q2 2026 2026-07-30 (confirmed via Amazon's own investor-relations release). Kill-switch per the existing thesis: either AWS growth rolls below ~20% with margins rolling over (bear), or capex monetization plus an FCF inflection forces a re-rating (bull). Not yet audited against this print." },
...
const PF_RADAR = {
  ...
  THEMES: [
    ...
    { id:"ny-dc-moratorium", label:"State-level data-center siting bans (NY 50MW+ pause)", direction:"threatens",
      ...
      note:"EQIX was a small satellite position (~$98 notional) with no thesis and no PF_PRESCREEN entry on file — fully sold 2026-07-30 as part of the rotation into core ETFs, so holdings is now empty here. Coverage stays 'n/a' — this row exists to watch entitled-vs-coastal siting bifurcation generally; META/MSFT/AMZN/GOOGL have diffuse secondary exposure (they lease/site DCs too) but at their scale a single state's pause is immaterial — not added as holdings here to avoid diluting the row's actual point." },
